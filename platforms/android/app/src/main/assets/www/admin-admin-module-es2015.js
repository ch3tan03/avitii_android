    ...
    constructor(dialog, socketService, alertService, utilityService, authenticationService, router, elementRef, userService, _cdr) {
        ...
        this.socketService.getSessionApplyAllByQuery(false, _data, null)
            ...
            if (data && data['success']) {
                ...
                let _allUsersArray = lodash__WEBPACK_IMPORTED_MODULE_13__["map"](lodash__WEBPACK_IMPORTED_MODULE_13__["uniq"](lodash__WEBPACK_IMPORTED_MODULE_13__["union"](lodash__WEBPACK_IMPORTED_MODULE_13__["map"](_dataObj, 'borrowerId'), lodash__WEBPACK_IMPORTED_MODULE_13__["map"](_dataObj, 'lenderId'))), '_id');
            ...
            if (_LoanObj) {
                ...
                switch (this.authenticationService.currentUserValue.role) {
                    case src_app_models__WEBPACK_IMPORTED_MODULE_9__["Role"].Borrower:
                        ...
                        _proccessedSessionObj.sessionAppliedByBorrowers = lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](_LoanObj.sessionAppliedByBorrowers, { "borrowerId": { "_id": this.authenticationService.currentUserValue._id } });
                        break;
                    case src_app_models__WEBPACK_IMPORTED_MODULE_9__["Role"].Lender:
                        _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_13__["cloneDeep"](_LoanObj);
                        _proccessedSessionObj.sessionAppliedByBorrowers = lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](_LoanObj.sessionAppliedByBorrowers, { "lenderId": { "_id": this.authenticationService.currentUserValue._id } }); //_sessionAppliedByLenders
                        break;
                    default:
                        _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_13__["cloneDeep"](_LoanObj);
                        break;
    ...
    showAppliedToSession(sessionObj) {
        ...
        switch (this.authenticationService.currentUserValue.role) {
            case src_app_models__WEBPACK_IMPORTED_MODULE_9__["Role"].Borrower:
                ...
                _proccessedSessionObj.sessionAppliedByBorrowers = lodash__WEBPACK_IMPORTED_MODULE_13__["filter"](sessionObj.sessionAppliedByBorrowers, { "lenderId": { "_id": this.authenticationService.currentUserValue._id } });
                break;
            default:
                _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_13__["cloneDeep"](sessionObj);
                break;
...
HomeComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"],
        src_app_services_contact_service__WEBPACK_IMPORTED_MODULE_7__["ContactService"],
