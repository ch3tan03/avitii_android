(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["lender-lender-module"], {
    ...
    function KJmD(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_stripe_component_stripe_component_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ../shared/stripe-component/stripe-component.component */
      "2o0M");
      ...
      var routes = [{
        ...
        children: [{
          ...
          canActivate: [_components_guards_roles_guard__WEBPACK_IMPORTED_MODULE_16__["RolesGuard"]],
          path: 'payment-stripe',
          component: _shared_stripe_component_stripe_component_component__WEBPACK_IMPORTED_MODULE_25__["StripeComponentComponent"]
        }, {
          canActivate: [_components_guards_roles_guard__WEBPACK_IMPORTED_MODULE_16__["RolesGuard"]],
          path: 'make-a-loan',
    ...
    function bSvo(module, __webpack_exports__, __webpack_require__) {
      ...
      var MySessionsComponent = /*#__PURE__*/function () {
        function MySessionsComponent(authenticationService, socketService, dialog, contactService, utilityService, alertService, userService, router) {
          var _this5 = this;
          ...
          this.subscription = this.socketService.getCurrentSessionAll().subscribe(function (_allSessionsData) {
            if (_allSessionsData) {
              _this5.allSessionsData = _allSessionsData;
          ...
          this.socketService.getUpdatesForSessionAllByLenderId().subscribe(function (data) {
            if (data && data['success']) {
              ...
              _this5.allSessionsData = _this5.utilityService._.values(_keyPairedMapObj); //this.loading = false;
                  ...
                  if (result.data.status && result.data.sessionApply) {
                    ...
                    switch (_status) {
                      case _models__WEBPACK_IMPORTED_MODULE_6__["SessionStatus"].Accepted:
                        ...
                        _this6.proccedAppliedToSession(sessionObj, _loanApplyId);
    ...
    function fxdU(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(dialog, router, authenticationService, socketService, utilityService, fundService, contactService) {
          var _this7 = this;
          ...
          this.subscription = this.socketService.getCurrentOnlineUsersListObj().subscribe(function (_currentOnlineUserList) {
            if (_currentOnlineUserList) {
              _this7.currentOnlineUserList = _currentOnlineUserList;
            } else {
              _this7.currentOnlineUserList = null;
            }
          });
          this.subscription1 = this.socketService.getCurrentSessionCount().subscribe(function (_allSessionsCount) {
            if (_allSessionsCount) {
              _this7.allSessionsCount = _allSessionsCount;
            } else {
              _this7.allSessionsCount = 0;
            }
          });
          this.subscription2 = this.authenticationService.getCurrentUserObj().subscribe(function (_currentUser) {
            if (_currentUser) {
              ...
              _this7.socketService.getSessionAllTodaysDateAcceptedOnly(_this7.currentUser._id, _this7.currentUser.role).subscribe(function (result) {
                var data = null;
                ...
                _this7.allSessionsTodayList = data;

                if (_this7.utilityService._.keys(_this7.allSessionsTodayList).length <= 0) {
                  _this7.allSessionsTodayList = [];
                }

                _this7.allSessionsTodayCount = _this7.utilityService._.keys(_this7.allSessionsTodayList).length;
              });
            } else {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_8__["MatDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"], src_app_socketio_service__WEBPACK_IMPORTED_MODULE_4__["SocketioService"], src_app_services_utility_service__WEBPACK_IMPORTED_MODULE_10__["UtilityService"], src_app_services_add_funds_service__WEBPACK_IMPORTED_MODULE_11__["AddFundsService"], src_app_services_contact_service__WEBPACK_IMPORTED_MODULE_12__["ContactService"]])], HomeComponent);
      /***/
    },
          ...
          if (paramobj) {
            ...
            if (this.loanId) {
              this.sessionsService.getSessionById(this.loanId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                ...
                if (data && data['success']) {
                  //alert(JSON.stringify( data));
                  _this8.showEditingForm(data["data"]); //this.alertService.success(data['message'], true);


                  _this8.loading = false; //this.element_btn_click_addSession_skills_verification.click();
                } else {
                  //alert(JSON.stringify(data['message']));
                  _this8.alertService.error(data['message']);
          ...
          value: function onaddSessionUpdateSubmit() {
            ...
            if (this.loanId) {
              this.sessionsService.updateSessionById(this.addSessionForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                if (data && data['success']) {
                  //alert(JSON.stringify( data));
                  _this9.alertService.success('Loan Request Updated successfully', true);

                  _this9.appRouterService.appRouter(_this9.authenticationService.currentUserValue);
                } else {
                  //alert(JSON.stringify(data['message']));
                  _this9.alertService.error(data['message']);
              ...
              this.sessionsService.addNewSession(this.addSessionForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                if (data && data['success']) {
                  //alert(JSON.stringify( data));
                  _this9.alertService.success('New Loan added to loan market. you will receive borrowers request in received tab.', true);
    ...
    function swyj(module, __webpack_exports__, __webpack_require__) {
      ...
      var LendNowComponent = /*#__PURE__*/function () {
          ...
          if (paramobj) {
            ...
            if (this.loanId) {
              this.socketioService.getLoanMarketDataById(this.loanId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                ...
                if (data && data['success']) {
                  if (data["data"]) {
                    ...
                    if (data["data"]["_id"]) {
                      _this10.LoanObj = data["data"];
                    } else {
                      _this10.LoanObj = data["data"][0];
                    }

                    var _obj4LoanApply = null;

                    if (_this10.loanApplyId) {
                      _obj4LoanApply = lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](_this10.LoanObj.sessionAppliedByBorrowers, {
                        "_id": _this10.loanApplyId
                      })[0];

                      _this10.showEditingForm(_obj4LoanApply);
                    }

                    var _userIdOfLoanCreatorOrEditorWhichisNotCurrentUser = _this10.LoanObj.createdByUserObj._id;

                    if (_this10.loanApplyId) {
                      if (_this10.authenticationService.currentUserValue._id == _this10.LoanObj.createdByUserObj._id) {
                    ...
                    _this10.userService.getUserById(_userIdOfLoanCreatorOrEditorWhichisNotCurrentUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                      if (data && data['success']) {
                        _this10.borrowerUserObj = lodash__WEBPACK_IMPORTED_MODULE_12__["cloneDeep"](data['data']);
                        ...
                        _this10.appRouterService.appRouter('');
                      }
                    }, function (error) {
                      var errorMsg2show = "";
                ...
                _this10.appRouterService.appRouter(''); //#endregion proccess for failure here
              ...
              this.userService.getUserById(this.authenticationService.currentUserValue._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                //#region proccess for success here
                if (data && data['success']) {
                  _this10.lenderUserObj = data["data"];
                  _this10.loading = false;
                } else {
                  _this10.alertService.error(data['message']);
        ...
        _createClass(LendNowComponent, [{
          ...
          key: "initiatePayment",
          value: function initiatePayment(event) {
          ...
          value: function initiateForPaymentForLender(_loanId, _loanApplyId, _endUserId, _amount4Payment, _header4Payment, _transactiActionType, _currency, _selectedPaymentMethod, _paymentUniqId) {
            ...
            this.payment.initPaymentConfigStripe(PaymentObj); //this.socketService.setSessionApplyUpdateStatus(false, _loanId, _loanApplyId, _status, this.authenticationService.currentUserValue._id);    
