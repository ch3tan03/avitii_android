        ...
        _createClass(HomeComponent, [{
          ...
          value: function usersProfile(userObj) {
            ...
            this.userService.getUserById(userObj._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["first"])()).subscribe(function (data) {
              if (data && data['success']) {
                //console.log('84', this.authenticationService.currentUserValue);
                var dialogRef = _this21.dialog.open(src_app_shared_public_profile_public_profile_component__WEBPACK_IMPORTED_MODULE_9__["PublicProfileComponent"], {
                  maxWidth: '100vw',
                  maxHeight: '100vh',
                  height: '100%',
                  width: '100%',
                  hasBackdrop: true,
                  data: {
                    userObj: _this21.utilityService._.cloneDeep(data['data']),
                    adminViewT: false
                  }
                });
          ...
          if (paramobj) {
            ...
            if (this.loanId) {
              this.sessionsService.getSessionById(this.loanId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                ...
                if (data && data['success']) {
                  //alert(JSON.stringify( data));
                  _this22.showEditingForm(data["data"]); //this.alertService.success(data['message'], true);


                  _this22.loading = false; //this.element_btn_click_addSession_skills_verification.click();
                } else {
                  //alert(JSON.stringify(data['message']));
            ...
            if (this.loanId) {
              this.sessionsService.updateSessionById(this.addSessionForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                if (data && data['success']) {
                  ...
                  _this23.alertService.success("Loan Request Updated successfully. Loan contract is available under My Contract->My Contract tab.", true);

                  _this23.appRouterService.appRouteToPath("/lender/my-contract", {
              ...
              this.sessionsService.addNewSession(this.addSessionForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                if (data && data['success']) {
                  ...
                  //this.appRouterService.appRouter(this.authenticationService.currentUserValue);
                  _this23.alertService.success("New Loan added to loan market. Loan contract is available under My Contract->My Contract tab.", true);
          ...
          if (paramobj) {
            ...
            if (this.loanId) {
              this.socketService.getLoanMarketDataById(this.loanId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                ...
                if (data && data['success']) {
                  if (data["data"]) {
                    ...
                    if (data["data"]["_id"]) {
                      _this24.LoanObj = data["data"];
                    } else {
                      _this24.LoanObj = data["data"][0];
                    }

                    var _obj4LoanApply = null;

                    if (_this24.loanApplyId) {
                      _obj4LoanApply = lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](_this24.LoanObj.sessionAppliedByBorrowers, {
                        "_id": _this24.loanApplyId
                      })[0];

                      _this24.showEditingForm(_obj4LoanApply);
                    }

                    var _userIdOfLoanCreatorOrEditorWhichisNotCurrentUser = _this24.LoanObj.createdByUserObj._id;

                    if (_this24.loanApplyId) {
                      if (_this24.authenticationService.currentUserValue._id == _this24.LoanObj.createdByUserObj._id) {
                    ...
                    _this24.userService.getUserById(_userIdOfLoanCreatorOrEditorWhichisNotCurrentUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                      if (data && data['success']) {
                        _this24.borrowerUserObj = lodash__WEBPACK_IMPORTED_MODULE_12__["cloneDeep"](data['data']);
                        ...
                        */
                        ...
                        _this24.appRouterService.appRouter('');
                      }
                    }, function (error) {
                      var errorMsg2show = "";
                ...
                _this24.appRouterService.appRouter(''); //#endregion proccess for failure here
              ...
              this.userService.getUserById(this.authenticationService.currentUserValue._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
                //#region proccess for success here
                if (data && data['success']) {
                  _this24.lenderUserObj = data["data"];
                  _this24.loading = false;

                  if (_this24.loanApplyId) {
                    _this24.clickedOnSignLoanContract();
                  }
                } else {
                  _this24.alertService.error(data['message']);
        ...
        _createClass(LendNowComponent, [{
          ...
          value: function initiatePayment() {
            ...
            if (this.lendNowForm.get('loanInsuranceRequired').value) {
              ...
              var _header4Payment = 'Insurance Payment for ' + this.utilityService.returnLoanType(this.LoanObj.loanType); //debugger;
          ...
          value: function initiateForPaymentForLender(_loanId, _loanApplyId, _endUserId, _amount4Payment, _header4Payment, _transactiActionType, _currency, _selectedPaymentMethod, _paymentUniqId) {
            ...
            this.payment.getCurrentPaymentApproved().subscribe(function (_obj) {
              if (_obj && _obj.success) {
                var userObj = _this26.authenticationService.currentUserValue;

                _this26.lendNowForm.get('loanInsuranceAmount').setValue(PaymentObj.amount4Payment);

                _this26.lendNowForm.get('loanInsuranceRequired').setValue(true);

                _this26.lendNowForm.get('loanInsuranceCreatedOn').setValue(lodash__WEBPACK_IMPORTED_MODULE_12__["now"]());

                _this26.clickedOnVerifiedSignLoanContract();
              } else {
                _this26.alertService.error(_obj.message || "Payment failed");

                _this26.lendNowForm.get('loanInsuranceAmount').setValue(0);

                _this26.lendNowForm.get('loanInsuranceRequired').setValue(false);

                _this26.lendNowForm.get('loanInsuranceCreatedOn').setValue(null);
              }

              _this26.resetStatusOfPayment();

              _this26.payment.sendCurrentPaymentFailed(true);
          ...
          value: function usersProfile(userObj) {
            ...
            this.userService.getUserById(userObj._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(function (data) {
              if (data && data['success']) {
                //console.log('84', this.authenticationService.currentUserValue);
                var dialogRef = _this27.dialog.open(src_app_shared_public_profile_public_profile_component__WEBPACK_IMPORTED_MODULE_16__["PublicProfileComponent"], {
                  maxWidth: '100vw',
                  maxHeight: '100vh',
                  height: '100%',
                  width: '100%',
