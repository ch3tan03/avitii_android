  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["borrower-borrower-module"], {
      ...
      var CalendarComponent = /*#__PURE__*/function () {
        ...
        _createClass(CalendarComponent, [{
          ...
          value: function handleEeventClick(arg) {
            ...
            var _sessionApplyObj = this.utilityService._.first(_sessionObj.sessionAppliedByLenders);
            ...
            if (_currentSessionApply) {
              ...
              switch (_currentSessionApply.status) {
                case src_app_models_role__WEBPACK_IMPORTED_MODULE_7__["SessionStatus"].Accepted:
                  ...
                  var _currentContactObj = this.contactService.returnContactJsonData(this.authenticationService.currentUserValue._id, _LoanObj.loanType + " - " + this.borrowerUserObj.firstName, this.LoanObj._id, _currentSessionApply._id, _adminUsersArray, null, null);
    ...
    function CgDp(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(userService, socketService, formBuilder, sessionsService, alertService, utilityService, dialog, authenticationService, fundService, router, contactService) {
          var _this4 = this;
          ...
          this.subscription = this.socketService.getCurrentOnlineUsersListObj().subscribe(function (_currentOnlineUserList) {
            if (_currentOnlineUserList) {
              _this4.currentOnlineUserList = _currentOnlineUserList;
            } else {
              _this4.currentOnlineUserList = null;
            }
          });
          this.subscription1 = this.socketService.getCurrentSessionCount().subscribe(function (_allSessionsCount) {
            if (_allSessionsCount) {
              _this4.allSessionsCount = _allSessionsCount;
            } else {
              _this4.allSessionsCount = null;
            }
          });
          var _obj2Use4Filter = {
            role: 'borrower'
          ...
          this.socketService.getSessionAllTodaysDateAcceptedOnly(this.authenticationService.currentUserValue._id, this.authenticationService.currentUserValue.role).subscribe(function (result) {
            var data = null;
            ...
            _this4.allSessionsTodayList = data;

            if (_this4.utilityService._.keys(_this4.allSessionsTodayList).length <= 0) {
              _this4.allSessionsTodayList = [];
            }

            _this4.allSessionsTodayCount = _this4.utilityService._.keys(_this4.allSessionsTodayList).length;
          });
        }
        ...
        _createClass(HomeComponent, [{
          key: "f",
          get: function get() {
            return this.homeComponantForm.controls;
          }
        }, {
          ...
          value: function sessionSearchByService() {
            ...
            var generaldata4search = this.homeComponantForm.get('generaldata4search').value;
            var useAndTrueOrFalse = false;
            this.allSessionsData = [];
            this.sessionsService.getSessionAllByService('', '', generaldata4search, generaldata4search, useAndTrueOrFalse).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["first"])()).subscribe(function (data) {
              //console.log('data => ', data)
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this5.allSessionsData = data['data']; //this.alertService.success(data['message'], true);

                _this5.userService.proccessAllAppUsersCollections(_this5.utilityService._.uniq(_this5.utilityService._.map(_this5.utilityService._.flattenDepth(_this5.utilityService._.map(_this5.utilityService._.values(_this5.allSessionsData), "sessionAppliedByBorrowers"), 1), 'borrowerId')));
          ...
          value: function ngOnInit() {
            ...
            this.sessionsService.getSessionAllWithSessionApply(this.authenticationService.currentUserValue._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["first"])()).subscribe(function (data) {
              //console.log('data => ', data)
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this6.allSessionsData = data['data'];

                _this6.userService.proccessAllAppUsersCollections(_this6.utilityService._.uniq(_this6.utilityService._.map(_this6.utilityService._.flattenDepth(_this6.utilityService._.map(_this6.utilityService._.values(_this6.allSessionsData), "sessionAppliedByBorrowers"), 1), 'borrowerId'))); //this.alertService.success(data['message'], true);


                _this6.loading = false; //this.element_btn_click_addSession_skills_verification.click();
              } else {
                //alert(JSON.stringify(data['message']));
                //this.alertService.error(data['message']);
            ...
            this.sessionsService.getUpdatesForSessionAllByBorrowerId().subscribe(function (data) {
              if (data && data['success']) {
                ...
                _this6.allSessionsData = _this6.utilityService._.values(_keyPairedMapObj);
                _this6.loading = false;
              } else {
                _this6.loading = false;
              }
            ...
            this.sessionsService.getSessionLengthByService(null, null, null, null, null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["first"])()).subscribe(function (data) {
              //console.log('data => ', data)
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this6.allSessionsCount = data['data']; //this.alertService.success(data['message'], true);
          ...
          value: function check4applyToSession(sessionObj) {
            if (sessionObj && sessionObj.sessionAppliedByBorrowers) {
              if (lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](sessionObj.sessionAppliedByBorrowers, {
                "borrowerId": this.authenticationService.currentUserValue._id
              }).length > 0) {
                return true;
              }
          ...
          value: function applyToSession(sessionObj) {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              ...
              if (result) {
                if (result.data) {
                  ...
                  if (_currentSessionApply) {
                    ...
                    _currentSessionApply.status = result.data.status || src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Pending;

                    _this7.socketService.sendCurrentAppliedSessionObj(_currentSessionApply.loanId);

                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Pending:
                        _this7.socketService.setSessionApply(true, _currentSessionApply);

                        break;

                      default:
                        _this7.socketService.updateSessionApply(true, _currentSessionApply, _this7.authenticationService.currentUserValue);
                    ...
                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Accepted:
                        _this7.alertService.success("Updated. Session is available under My Sessions->Accepted tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Pending:
                        _this7.alertService.success("Added. Session is available under My Sessions->Pending tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Rejected:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].RejectedOngoing:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].RejectedOngoingWithRefund:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Suspended:
                        _this7.alertService.success("Updated. Session is available under My Sessions->Rejected tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Completed:
                        _this7.alertService.success("Updated. Session is available under My Sessions->Completed tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Active:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].Ongoing:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].OngoingInitiated:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_13__["SessionStatus"].OngoingAccepted:
                        _this7.alertService.success("Updated. Session is available under My Sessions->Ongoing tab.", true);
              ...
              console.log("239 :: hc :: Dialog result: ".concat(JSON.stringify(result)));
            });
          }
        }, {
          ...
          value: function clickedOnSessionChatVideo(sessionObj, AVTrueChatFalse) {
            ...
            switch (this.authenticationService.currentUserValue.role) {
              ...
              case src_app_models__WEBPACK_IMPORTED_MODULE_13__["Role"].Admin:
    ...
    function Denz(module, __webpack_exports__, __webpack_require__) {
      ...
      var MySessionsComponent = /*#__PURE__*/function () {
        function MySessionsComponent(socketService, sessionsService, alertService, utilityService, dialog, authenticationService, userService, router) {
    ...
    function Fw9W(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".container_read {\r\n    height: 70px;\r\n    overflow: hidden;\r\n  }\r\n  \r\n  .show_more {\r\n    overflow: visible;\r\n    height: auto;\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
      ...
      var GetALoanComponent = /*#__PURE__*/function () {
        ...
        _createClass(GetALoanComponent, [{
          ...
          value: function calculateMonthlyAmountForEMI() {
            ...
            var loanInterestRate = this.addSessionForm.get('loanInterestRate').value || 0; //this._calculatedMonthlyAmountForEMI = loanAmount * loanInterestRate * (((1 + loanInterestRate) ^ loanTenureInMonths) / ((1 + loanInterestRate) ^ (loanTenureInMonths - 1)));
    ...
    function Vjsn(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoanMarketComponent = /*#__PURE__*/function () {
        function LoanMarketComponent(socketService, utilityService, alertService, router, authenticationService) {
          var _this13 = this;
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_socketio_service__WEBPACK_IMPORTED_MODULE_9__["SocketioService"], src_app_services_utility_service__WEBPACK_IMPORTED_MODULE_8__["UtilityService"], src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_6__["AlertService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticationService"]])], LoanMarketComponent);
      /***/
    },
      ...
      var HeaderComponent = /*#__PURE__*/function () {
        function HeaderComponent(router, authenticationService, alertService, sessionsService, dialog, serviceTypesService, socketService, fundService, utilityService, notificationService) {
          ...
          this.authenticationService.currentUser.subscribe(function (x) {
            _this14.currentUser = x;

            if (!_this14.currentUser) {
              return;
            }

            fundService.getFundsCountForRequestedUser(_this14.currentUser._id);
            fundService.getSessionSpentCountForRequestedUser(_this14.currentUser._id);

            _this14.sessionsService.getSessionAllWithSessionApply(_this14.authenticationService.currentUserValue._id).subscribe(function (data) {
              //console.log('data => ', data)
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this14.allSessionsData = data['data']; //this.alertService.success(data['message'], true);

                _this14.loading = false; //this.element_btn_click_addSession_skills_verification.click();
              } else {
                //alert(JSON.stringify(data['message']));
                //this.alertService.error(data['message']);
          ...
          this.sessionsService.getSessionInstastTypeAdded().subscribe(function (data) {
            if (data && data['success']) {
              if (!_this14.allInstantSessionsData) {
                _this14.allInstantSessionsData = [];
              }

              var _currentSessionObj = data['data'];

              var _existingSessionObjKryPair = lodash__WEBPACK_IMPORTED_MODULE_8__["mapKeys"](lodash__WEBPACK_IMPORTED_MODULE_8__["values"](_this14.allInstantSessionsData), '_id');
              ...
              _this14.allInstantSessionsData = lodash__WEBPACK_IMPORTED_MODULE_8__["values"](_existingSessionObjKryPair);
          ...
          this.socketService.getSessionUpdates().subscribe(function (data) {
            if (data && data['success']) {
              if (!_this14.allSessionsData) {
                _this14.allSessionsData = [];
              }

              var _currentSessionObj = data['data'];

              var _existingSessionObjKryPair = lodash__WEBPACK_IMPORTED_MODULE_8__["mapKeys"](lodash__WEBPACK_IMPORTED_MODULE_8__["values"](_this14.allSessionsData), '_id');
              ...
              _existingSessionObjKryPair[_currentSessionObj._id] = _currentSessionObj;
              _this14.allSessionsData = lodash__WEBPACK_IMPORTED_MODULE_8__["values"](_existingSessionObjKryPair);
            } else {//this.alertService.error(data['message']);
            }
          }, function (error) {});
          this.serviceTypesService.getServiceTypesChildAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["first"])()).subscribe(function (data) {
            ...
            if (data && data['success']) {
              //alert(JSON.stringify( data));
              _this14.ParentServicesTypes = data["data"]; //this.alertService.success(data['message'], true);

              _this14.loading = false; //this.element_btn_click_addServiceTypes_skills_verification.click();
            } else {
              //alert(JSON.stringify(data['message']));
              ...
              if (result) {
                if (result.data) {
                  ...
                  if (_currentSessionApply) {
                    ...
                    _this15.socketService.sendCurrentAppliedSessionObj(_currentSessionApply.loanId);

                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].Pending:
                        _this15.socketService.setSessionApply(true, _currentSessionApply);

                        break;

                      default:
                        _this15.socketService.updateSessionApply(true, _currentSessionApply, _this15.authenticationService.currentUserValue);
                    ...
                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].Accepted:
                        _this15.alertService.success("Updated. Session is available under My Sessions->Accepted tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].Pending:
                        _this15.alertService.success("Added. Session is available under My Sessions->Pending tab.", true);
                      ...
                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].Suspended:
                        _this15.alertService.success("Updated. Session is available under My Sessions->Rejected tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].Completed:
                        _this15.alertService.success("Updated. Session is available under My Sessions->Completed tab.", true);
                      ...
                      case src_app_models__WEBPACK_IMPORTED_MODULE_5__["SessionStatus"].OngoingAccepted:
                        _this15.alertService.success("Updated. Session is available under My Sessions->Ongoing tab.", true);
    ...
    function mtiP(module, __webpack_exports__, __webpack_require__) {
      ...
      var _models_role__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../models/role */
      "z56L");
      /* harmony import */
      ...
      var _services_contact_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _services_utility_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      ...
      var ModalApplySession = /*#__PURE__*/function () {
        function ModalApplySession(dialogRef, data, utilityService) {
          ...
          this.utilityService = utilityService;
          this.arrayItems = [0];
          this.SessionStatus = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"];
          this.editing = false;
          this.SessionExecutionType = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionExecutionType"];
          ...
          if (!data.LoanApplyObj) {
            ...
            this.LoanApplyObj.sessionExecutionType = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionExecutionType"].FixedPrice;
        ...
        _createClass(ModalApplySession, [{
          ...
          value: function returnSessionApplyStatus(LoanApplyObj) {
            var _currentStatus = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Pending;

            try {
              if (LoanApplyObj.status == _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Pending || LoanApplyObj.status == 'Pending' || LoanApplyObj.status == '' || LoanApplyObj.status == null || typeof LoanApplyObj.status == 'undefined') {
                _currentStatus = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Pending;
              } else {
            ...
            try {
              if (LoanApplyObj.status != _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Pending && LoanApplyObj.status != _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Rejected && LoanApplyObj.status != _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].RejectedOngoing) {
      ...
      ModalApplySession.ctorParameters = function () {
        return [{
          ...
          type: _services_utility_service__WEBPACK_IMPORTED_MODULE_13__["UtilityService"]
        }];
      };
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_utility_service__WEBPACK_IMPORTED_MODULE_13__["UtilityService"]])], ModalApplySession); //#endregion modal popup for apply LoanObj
      //#region modal popup for display applied sessions

      var ModalAppliedSessionDisplay = /*#__PURE__*/function () {
        function ModalAppliedSessionDisplay(dialogRef, data, userService, utilityService, dialog, router, authenticationService, contactService) {
        ...
        _createClass(ModalAppliedSessionDisplay, [{
          ...
          value: function returnUrl4downloadCOntractPDF(sessionApplyId) {
            var Url4downloadCOntractPDF = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].apiUrl + '/signed_pdf_contract/' + sessionApplyId + '.pdf';
          ...
          value: function closeDialog(_sessionApply, _status) {
            ...
            switch (_status) {
              case _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Accepted:
              ...
              case _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Ongoing:
                //#region handle LoanObj accepted
                //#endregion handle LoanObj accepted
                break;

              case _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].RejectedOngoingWithRefund:
          ...
          value: function clickedOnSessionChatVideo(sessionObj, AVTrueChatFalse) {
            ...
            switch (this.authenticationService.currentUserValue.role) {
              case _models_role__WEBPACK_IMPORTED_MODULE_9__["Role"].Borrower:
                _parentRouting = 'borrower';
                break;

              case _models_role__WEBPACK_IMPORTED_MODULE_9__["Role"].Lender:
                _parentRouting = 'lender';
                break;

              case _models_role__WEBPACK_IMPORTED_MODULE_9__["Role"].Admin:
                _parentRouting = 'admin';
                break;
            }
      ...
      ModalAppliedSessionDisplay.ctorParameters = function () {
        return [{
          ...
          type: _services_contact_service__WEBPACK_IMPORTED_MODULE_11__["ContactService"]
        }];
      };
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_user_service__WEBPACK_IMPORTED_MODULE_12__["UserService"], _services_utility_service__WEBPACK_IMPORTED_MODULE_13__["UtilityService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _services__WEBPACK_IMPORTED_MODULE_10__["AuthenticationService"], _services_contact_service__WEBPACK_IMPORTED_MODULE_11__["ContactService"]])], ModalAppliedSessionDisplay); //#endregion modal popup for display applied sessions
    ...
    function qfzN(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! src/app/services/service-types.service */
      "7ZPZ");
      /* harmony import */
      ...
      var BrowseSessionsComponent = /*#__PURE__*/function () {
        function BrowseSessionsComponent(userService, socketService, formBuilder, sessionsService, alertService, utilityService, dialog, authenticationService, serviceTypesService) {
          var _this16 = this;
          ...
          this.serviceTypesService.getServiceTypesChildAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).subscribe(function (data) {
            //console.log('data => ', data)
            if (data && data['success']) {
              //alert(JSON.stringify( data));
              _this16.ParentServicesTypes = data["data"]; //this.alertService.success(data['message'], true);

              _this16.loading = false; //this.element_btn_click_addServiceTypes_skills_verification.click();
            } else {
              //alert(JSON.stringify(data['message']));
              _this16.alertService.error(data['message']);

              _this16.loading = false;
            }
          }, function (error) {
            var errorMsg2show = "";
            _this16.ParentServicesTypes = [];
        ...
        _createClass(BrowseSessionsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.sessionsService.getSessionAllWithSessionApply(this.authenticationService.currentUserValue._id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).subscribe(function (data) {
              ...
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this17.allSessionsData = data['data'];

                _this17.userService.proccessAllAppUsersCollections(_this17.utilityService._.uniq(_this17.utilityService._.map(_this17.utilityService._.flattenDepth(_this17.utilityService._.map(_this17.utilityService._.values(_this17.allSessionsData), "sessionAppliedByBorrowers"), 1), 'borrowerId'))); //this.alertService.success(data['message'], true);
            ...
            this.sessionsService.getUpdatesForSessionAllByBorrowerId().subscribe(function (data) {
              if (data && data['success']) {
                var _keyPairedMapObj = _this17.utilityService._.mapKeys(_this17.allSessionsData, "_id");
                ...
                _this17.allSessionsData = _this17.utilityService._.values(_keyPairedMapObj);
                _this17.loading = false;
              } else {
                _this17.loading = false;
              }
            ...
            this.sessionsService.getSessionLengthByService(null, null, null, null, null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).subscribe(function (data) {
              ...
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this17.allSessionsCount = data['data']; //this.alertService.success(data['message'], true);
          ...
          value: function sessionSearchByService() {
            ...
            this.sessionsService.getSessionAllByService(services, location, generaldata4search, generaldata4search, useAndTrueOrFalse).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).subscribe(function (data) {
              ...
              if (data && data['success']) {
                //alert(JSON.stringify( data));
                _this18.allSessionsData = data['data'];

                _this18.userService.proccessAllAppUsersCollections(_this18.utilityService._.uniq(_this18.utilityService._.map(_this18.utilityService._.flattenDepth(_this18.utilityService._.map(_this18.utilityService._.values(_this18.allSessionsData), "sessionAppliedByBorrowers"), 1), 'borrowerId'))); //this.alertService.success(data['message'], true);


                _this18.loading = false; //this.element_btn_click_addSession_skills_verification.click();
              } else {
                //alert(JSON.stringify(data['message']));
                //this.alertService.error(data['message']);
              ...
              if (result) {
                if (result.data) {
                  ...
                  if (_currentSessionApply) {
                    ...
                    _this19.socketService.sendCurrentAppliedSessionObj(_currentSessionApply.loanId);

                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].Pending:
                        _this19.socketService.setSessionApply(true, _currentSessionApply);

                        break;

                      default:
                        _this19.socketService.updateSessionApply(true, _currentSessionApply, _this19.authenticationService.currentUserValue);
                    ...
                    switch (_currentSessionApply.status) {
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].Accepted:
                        _this19.alertService.success("Updated. Session is available under My Sessionss ->Accepted tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].Pending:
                        _this19.alertService.success("Applied. Session is available under My Sessionss->Pending tab.", true);
                      ...
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].RejectedOngoingWithRefund:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].Suspended:
                        _this19.alertService.success("Updated. Session is available under My Sessionss->Rejected tab.", true);

                        break;

                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].Completed:
                        _this19.alertService.success("Updated. Session is available under My Sessionss->Completed tab.", true);
                      ...
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].OngoingInitiated:
                      case src_app_models__WEBPACK_IMPORTED_MODULE_12__["SessionStatus"].OngoingAccepted:
                        _this19.alertService.success("Updated. Session is available under My Sessionss->Ongoing tab.", true);
      ...
      BrowseSessionsComponent.ctorParameters = function () {
        return [{
          ...
          type: src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_13__["ServiceTypesService"]
        }];
      };
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services__WEBPACK_IMPORTED_MODULE_6__["UserService"], src_app_socketio_service__WEBPACK_IMPORTED_MODULE_14__["SocketioService"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormBuilder"], src_app_services_sessions_service__WEBPACK_IMPORTED_MODULE_5__["SessionsService"], src_app_services__WEBPACK_IMPORTED_MODULE_6__["AlertService"], src_app_services_utility_service__WEBPACK_IMPORTED_MODULE_4__["UtilityService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialog"], src_app_services__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"], src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_13__["ServiceTypesService"]])], BrowseSessionsComponent);
      /***/
    },
