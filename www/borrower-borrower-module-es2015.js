    ...
    proccedAppliedToSession(sessionObj, loanApplyId) {
        ...
        switch (this.authenticationService.currentUserValue.role) {
            ...
            case src_app_models__WEBPACK_IMPORTED_MODULE_13__["Role"].Lender:
                _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_12__["cloneDeep"](sessionObj);
                _proccessedSessionObj.sessionAppliedByBorrowers = lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](sessionObj.sessionAppliedByLenders, { "lenderId": this.authenticationService.currentUserValue._id });
                break;
            default:
                _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_12__["cloneDeep"](sessionObj);
                break;
...
let GetALoanComponent = class GetALoanComponent {
    ...
    showEditingForm(_userObj) {
        let _loanInterestRateValidation = [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(0)];
        switch (this.authenticationService.currentUserValue.role) {
            case src_app_models__WEBPACK_IMPORTED_MODULE_13__["Role"].Borrower:
...
let LoanMarketComponent = class LoanMarketComponent {
    constructor(userService, dialog, socketService, utilityService, alertService, router, authenticationService) {
        this.userService = userService;
        this.dialog = dialog;
        this.socketService = socketService;
        this.utilityService = utilityService;
...
/* harmony import */ var rxjs_internal_operators_first__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/internal/operators/first */ "XoMe");
/* harmony import */ var rxjs_internal_operators_first__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(rxjs_internal_operators_first__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/environments/environment */ "AytR");
/* harmony import */ var _models_role__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../models/role */ "z56L");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services */ "o0su");
/* harmony import */ var _services_contact_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/contact.service */ "3ITz");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../services/user.service */ "qfBg");
/* harmony import */ var _services_utility_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/utility.service */ "A1CT");
/* harmony import */ var _socketio_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../socketio.service */ "bgkY");
...
let ModalApplySession = class ModalApplySession {
    ...
    returnSessionApplyStatus(LoanApplyObj) {
        let _currentStatus = _models_role__WEBPACK_IMPORTED_MODULE_10__["SessionStatus"].Pending;
        try {
...
ModalApplySession = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_utility_service__WEBPACK_IMPORTED_MODULE_14__["UtilityService"]])
], ModalApplySession);
...
let ModalAppliedSessionDisplay = class ModalAppliedSessionDisplay {
    constructor(alertService, socketService, dialogRef, data, userService, utilityService, dialog, router, authenticationService, contactService) {
        this.alertService = alertService;
        this.socketService = socketService;
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    paymentDoneByLenderConfirmByBorrower(LoanApplyObj) {
        ...
        this.socketService.sendEventForLoanAmountPaidByLenderConfirmByBorrowerWithUpdateAll(LoanApplyObj.loanId, LoanApplyObj._id, this.authenticationService.currentUserValue._id, this.LoanApplyObjCurrent).pipe(Object(rxjs_internal_operators_first__WEBPACK_IMPORTED_MODULE_8__["first"])()).subscribe(details => {
    ...
    paymentDoneToLender(LoanApplyObj) {
        ...
        this.socketService.sendEventForLoanAmountPaidToLenderWithUpdateAll(LoanApplyObj.loanId, LoanApplyObj._id, this.authenticationService.currentUserValue._id, _installmentKey, _loanTenureInMonths, this.LoanApplyObjCurrent4Installment)
            .pipe(Object(rxjs_internal_operators_first__WEBPACK_IMPORTED_MODULE_8__["first"])())
            .subscribe(details => {
            if (details && details["success"]) {
                this.dialogRef.close({ event: 'close', data: { updatedSessionObj: details["data"] } });
            }
    ...
    returnUrl4downloadCOntractPDF(sessionApplyId) {
        let Url4downloadCOntractPDF = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].apiUrl + '/signed_pdf_contract/' + sessionApplyId + '.pdf';
...
ModalAppliedSessionDisplay = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_11__["AlertService"],
        _socketio_service__WEBPACK_IMPORTED_MODULE_15__["SocketioService"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_user_service__WEBPACK_IMPORTED_MODULE_13__["UserService"],
        _services_utility_service__WEBPACK_IMPORTED_MODULE_14__["UtilityService"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialog"],
        _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"],
        _services__WEBPACK_IMPORTED_MODULE_11__["AuthenticationService"],
        _services_contact_service__WEBPACK_IMPORTED_MODULE_12__["ContactService"]])
