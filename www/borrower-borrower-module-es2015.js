...
let BorrowNowComponent = class BorrowNowComponent {
    constructor(socketService, utilityService, socketioService, alertService, appRouterService, formBuilder, authenticationService, userService, contactService) {
        this.socketService = socketService;
        this.utilityService = utilityService;
...
let HomeComponent = class HomeComponent {
    constructor(userService, socketService, formBuilder, sessionsService, alertService, utilityService, dialog, authenticationService, fundService, router, contactService) {
        this.userService = userService;
        this.socketService = socketService;
        this.formBuilder = formBuilder;
        this.sessionsService = sessionsService;
    ...
    check4applyToSession(sessionObj) {
        if (sessionObj && sessionObj.sessionAppliedByBorrowers) {
            if (lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](sessionObj.sessionAppliedByBorrowers, { "borrowerId": this.authenticationService.currentUserValue._id }).length > 0) {
                return true;
            }
        }
        return false;
    ...
    showAppliedToSession(sessionObj) {
        ...
        switch (this.authenticationService.currentUserValue.role) {
            case src_app_models__WEBPACK_IMPORTED_MODULE_13__["Role"].Borrower:
                ...
                _proccessedSessionObj.sessionAppliedByBorrowers = lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](sessionObj.sessionAppliedByBorrowers, { "borrowerId": this.authenticationService.currentUserValue._id });
                break;
            default:
                _proccessedSessionObj = lodash__WEBPACK_IMPORTED_MODULE_12__["cloneDeep"](sessionObj);
                break;
...
let MySessionsComponent = class MySessionsComponent {
    constructor(socketService, sessionsService, alertService, utilityService, dialog, authenticationService, userService, router) {
        this.socketService = socketService;
        this.sessionsService = sessionsService;
        this.alertService = alertService;
        this.utilityService = utilityService;
        ...
        if (sessionObj && sessionObj.sessionAppliedByBorrowers) {
            if (checkCreatedBySelfT) {
                if (sessionObj.createdBy == this.authenticationService.currentUserValue._id) {
                    if (lodash__WEBPACK_IMPORTED_MODULE_11__["filter"](sessionObj.sessionAppliedByBorrowers, { "borrowerId": this.authenticationService.currentUserValue._id }).length > 0) {
                        return true;
                    }
                }
            }
...
const routes = [
    {
        ...
        children: [
            ...
            { canActivate: [_components_guards_roles_guard__WEBPACK_IMPORTED_MODULE_16__["RolesGuard"]], path: 'loan-market', component: _loan_market_loan_market_component__WEBPACK_IMPORTED_MODULE_17__["LoanMarketComponent"] },
            { canActivate: [_components_guards_roles_guard__WEBPACK_IMPORTED_MODULE_16__["RolesGuard"]], path: 'make-a-loan', component: _get_a_loan_get_a_loan_component__WEBPACK_IMPORTED_MODULE_18__["GetALoanComponent"] },
...
/* harmony import */ var src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/service-types.service */ "7ZPZ");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var _borrower_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../borrower.component */ "mtiP");
/* harmony import */ var src_app_socketio_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/socketio.service */ "bgkY");
/* harmony import */ var src_app_services_add_funds_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/services/add-funds.service */ "3gPe");
...
let HeaderComponent = class HeaderComponent {
    constructor(router, authenticationService, alertService, sessionsService, dialog, serviceTypesService, socketService, fundService, utilityService, notificationService) {
        this.router = router;
        this.authenticationService = authenticationService;
        this.alertService = alertService;
        this.sessionsService = sessionsService;
        ...
        this.serviceTypesService.getServiceTypesChildAll()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["first"])())
            .subscribe(data => {
            //console.log('data => ', data)
            if (data && data['success']) {
                //alert(JSON.stringify( data));
    ...
    showAppliedToSession(sessionObj) {
        ...
        console.log('214', this.authenticationService.currentUserValue);
        const dialogRef = this.dialog.open(_borrower_component__WEBPACK_IMPORTED_MODULE_13__["ModalAppliedSessionDisplay"], {
            backdropClass: 'cdk-overlay-transparent-backdrop',
            hasBackdrop: true,
            maxWidth: '100vw',
            maxHeight: '100vh',
...
HeaderComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        ...
        src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_11__["ServiceTypesService"],
        src_app_socketio_service__WEBPACK_IMPORTED_MODULE_14__["SocketioService"],
        src_app_services_add_funds_service__WEBPACK_IMPORTED_MODULE_15__["AddFundsService"],
        src_app_services_utility_service__WEBPACK_IMPORTED_MODULE_9__["UtilityService"],
        src_app_services_notification_service__WEBPACK_IMPORTED_MODULE_16__["NotificationService"]])
], HeaderComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BorrowerComponent", function() { return BorrowerComponent; });
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_borrower_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./borrower.component.html */ "Ccej");
/* harmony import */ var _borrower_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./borrower.component.css */ "VLNz");
/* harmony import */ var _raw_loader_modal_modal_apply_session_html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! raw-loader!./modal/modal-apply-session.html */ "njGU");
/* harmony import */ var _raw_loader_modal_modal_applied_session_display_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! raw-loader!./modal/modal-applied-session-display.html */ "4tmY");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material/dialog */ "0IaG");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/environments/environment */ "AytR");
/* harmony import */ var _models_role__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/role */ "z56L");
...
let BorrowerComponent = class BorrowerComponent {
    constructor(dialog) {
        this.dialog = dialog;
    }
    applyToSession() {
...
BorrowerComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialog"] }
];
BorrowerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let ModalApplySession = class ModalApplySession {
    ...
    returnSessionApplyStatus(LoanApplyObj) {
        let _currentStatus = _models_role__WEBPACK_IMPORTED_MODULE_9__["SessionStatus"].Pending;
        try {
...
ModalApplySession.ctorParameters = () => [
    ...
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_5__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MAT_DIALOG_DATA"],] }] },
...
ModalApplySession = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_utility_service__WEBPACK_IMPORTED_MODULE_13__["UtilityService"]])
], ModalApplySession);
...
let ModalAppliedSessionDisplay = class ModalAppliedSessionDisplay {
    constructor(dialogRef, data, userService, utilityService, dialog, router, authenticationService, contactService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.userService = userService;
        this.utilityService = utilityService;
    ...
    returnUrl4downloadCOntractPDF(sessionApplyId) {
        let Url4downloadCOntractPDF = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].apiUrl + '/signed_pdf_contract/' + sessionApplyId + '.pdf';
...
ModalAppliedSessionDisplay = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], Object, _services_user_service__WEBPACK_IMPORTED_MODULE_12__["UserService"],
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var src_app_models__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/models */ "VHTt");
/* harmony import */ var src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/app/services/service-types.service */ "7ZPZ");
/* harmony import */ var src_app_socketio_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/socketio.service */ "bgkY");
...
let BrowseSessionsComponent = class BrowseSessionsComponent {
    constructor(userService, socketService, formBuilder, sessionsService, alertService, utilityService, dialog, authenticationService, serviceTypesService) {
        this.userService = userService;
        this.socketService = socketService;
        this.formBuilder = formBuilder;
        this.sessionsService = sessionsService;
...
BrowseSessionsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services__WEBPACK_IMPORTED_MODULE_6__["UserService"],
        ...
        src_app_services__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"],
        src_app_services_service_types_service__WEBPACK_IMPORTED_MODULE_13__["ServiceTypesService"]])
