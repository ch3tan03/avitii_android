...
@Component({
  ...
  templateUrl: './user-management-pending.component.html',
  styleUrls: ['./user-management-pending.component.css']
})
export class UserManagementPendingComponent implements OnInit {
  ...
  getAllUsersWithRequestData(_skip: number = 0, callback: any = null, dataTablesParameters: any = null, returnOnlyPendingT:boolean=true) {
    let _data = {};
